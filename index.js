...
const prefixMap = [
  ...
  { prefix: 's2_page_country:', plugin: 'server2' },
  { prefix: 's2_pick_country:', plugin: 'server2' },
  { prefix: 's2_page_service:', plugin: 'server2' },
  { prefix: 's2_buy:', plugin: 'server2' },
  { prefix: 'ord2_cekotp:', plugin: 'server2' },
  { prefix: 'ord2_batal:', plugin: 'server2' },
